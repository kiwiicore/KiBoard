# KiBoard
> A fork of [NohBoard by ThoNohT](https://github.com/ThoNohT/NohBoard)

> [!Warning] 
> This project is currently in development and is not yet in a desired state.  
> This repository is only public so my progress can be tracked and issues can be found.  
> This warning will be removed once I am confident with what I have achieved in this project.
...
- [ ]  Smoother UX with a better customization pipeline
- [ ]  finish writing this todo list... *gulp...*

## License
KiBoard is licensed under the GPL version 2. The license agreement is attached in this repository and can be found [here](https://github.com/kiwiicore/KiBoard/blob/master/LICENSE).